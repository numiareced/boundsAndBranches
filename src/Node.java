...
public class Node {
	 ...
	 *            This node's parent
	 * @param parent_cost
	 *            The cost between these nodes
	 * @param distances
	 *            The 2D array of distance between locations
	 * @param active_set
	 *            The set of all points (including this node) that are being
	 *            calculated
	 * @param index
	 *            The location index of this node
	 */
...
//		if (Solver.flag)
			//System.out.println(parent_cost + " - " + index);
